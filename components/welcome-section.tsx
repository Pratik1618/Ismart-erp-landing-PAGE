...
const erpModules = [
  ...
  { id: 12, title: 'FDD (Financial Due Diligence)', description: 'Automated financial checks and risk validation for vendor and project approvals.', icon: Target },
  { id: 13, title: 'LDD (Legal Due Diligence)', description: 'Legal compliance checklists, lease documentation, and contract due diligence.', icon: Database },
